            ...
            {!emailSent && (
              <label className="w-full">
                ...
                <input
                  ...
                  className="w-full rounded-lg bg-richblack-700 text-richblack-5 border border-richblack-600 focus:border-yellow-50 focus:ring-1 focus:ring-yellow-50 outline-none px-4 py-3 placeholder:text-richblack-400 transition-all duration-200"
                />
              </label>
            )}
